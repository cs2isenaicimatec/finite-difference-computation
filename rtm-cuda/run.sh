...
do
	...
	perf record -e "cpu-clock, instructions, cache-references, cache-misses, L1-dcache-loads, L1-dcache-load-misses, LLC-loads, LLC-load-misses" ./rtm_cuda par=../models/new_mod/input.dat
	chmod 777 perf.data
